({
    doInit : function(component, event, helper) {
       ...
       /* component.set('v.columns', [
        ...
        component.set('v.columns', [
            {label: 'Salutation', fieldName: 'Salutation', type: 'text',sortable:true ,actions: headerActions},
            {label: 'FirstName', fieldName: 'FirstName', type: 'text',sortable:true,actions: headerActions},

({
    ...
    onInit : function(component, event, helper){
        var getSobject = component.get('c.getsObjects');
            getSobject.setCallback(this, $A.getCallback(function (response) {
    ...
    onSelectChange : function(component, event, helper){
        ...
        var sObjectName = {"sobjectType" : selectedObject};
        ...
        getFieldSet.setCallback(this, $A.getCallback(function (response) {
            var state = response.getState();
            if(component.isValid() && (state === 'SUCCESS' || state === 'DRAFT')){
    ...
    onFieldSetChange : function(component, event, helper){
        ...
        FiledSetMember.setCallback(this, $A.getCallback(function (response) {
            var state = response.getState();
            if(component.isValid() && (state === 'SUCCESS' || state === 'DRAFT')){
    ...
    onUpserObject : function(component, event, helper){
        ...
        upsertObject.setCallback(this, $A.getCallback(function (response) {
            var state = response.getState();
            if(component.isValid() && (state === 'SUCCESS' || state === 'DRAFT')){
